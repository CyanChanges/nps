...
docker buildx build --tag covid19sp/nps:$VERSION --tag covid19sp/nps:latest --output type=image,push=true --file Dockerfile.nps --platform=linux/amd64,linux/arm64,linux/386,linux/arm .
docker buildx build --tag covid19sp/npc:$VERSION --tag covid19sp/npc:latest --output type=image,push=true --file Dockerfile.npc --platform=linux/amd64,linux/arm64,linux/386,linux/arm .
